                ...
                return Padding(
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                '${totalToday.toStringAsFixed(2)} ريال',
                      ...
                      const Align(alignment: Alignment.centerRight, child: Text('التفاصيل:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
                      const SizedBox(height: 8),
                      Expanded(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: Column(
                        ...
                        children: [
                          Text(
                            '${debtor.totalDebt.toStringAsFixed(2)} ريال',
